...
const Hero: React.FC = () => {
  ...
  // Split links into categories. Exclude LinkedIn from socialLinks to show it separately.
  ...
  return (
    <section id="about" className="min-h-screen flex flex-col justify-end pb-24 px-4 sm:px-6 lg:px-12 pt-32 relative bg-transparent">
      <div className="max-w-7xl w-full mx-auto relative z-10">
        ...
        {/* Links Footer - 4 Lines Structure */}
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-2">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="flex items-center gap-2 text-base font-bold text-slate-700 dark:text-slate-300 hover:text-[#0a66c2] dark:hover:text-[#0a66c2] transition-colors group bg-slate-100 dark:bg-slate-800 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-700 hover:border-[#0a66c2] dark:hover:border-[#0a66c2]"
            >
